...
import { Send, Mail, User, MessageSquare, CheckCircle, AlertCircle, Facebook, Instagram } from "lucide-react";
...
export function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus({ 
        type: 'success', 
        message: 'Kiitos viestistäsi! Otamme sinuun yhteyttä pian. Olet saanut vahvistuksen sähköpostiisi.' 
      });
      ...
      setStatus({ 
        type: 'error', 
        message: error instanceof Error ? error.message : 'Viestin lähettämisessä tapahtui virhe. Yritä uudelleen.' 
      });
    }
  };
